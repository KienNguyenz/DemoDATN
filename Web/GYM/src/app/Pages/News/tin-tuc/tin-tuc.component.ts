...
export class TinTucComponent {
  ...
  pagedNewsList = [
    {
      image: 'assets/News/Nhung-ly-do-ban-nen-tap-thu-les-mills-body-pump-ngay-hom-nay-01.jpg',
      title: 'Những lý do bạn nên tập thử Les Mills body pump ngay hôm nay.',
      routerLink: '/news/news1'
    },
    {
      image: 'assets/News/ban-co-biet-les-mills-body-pump-giup-co-the-deo-dai-hon-01.jpg',
      title: 'Bạn có biết LES Mills body pump giúp cơ thể dẻo dai hơn.',
      routerLink: '/news/news2'
    },
    {
      image: 'assets/News/ly-do-les-mills-body-attack-la-bai-tap-hoan-hao-de-phat-trien-co-bap-toan-dien-01.jpg',
      title: 'Lý do Les Mills body attack là bài tập hoàn hảo để phát triển cơ bắp toàn diện.',
      routerLink: '/news/news3'
    },
    {
      image: 'assets/News/nhung-tac-dong-tich-cuc-den-suc-khoe-khi-tap-les-mills-body-combat-01.jpg',
      title: 'Những tác động tích cực đến sức khoẻ khi tập Les Mills body combat.',
      routerLink: '/news/news4'
    },
    {
      image: 'assets/News/tai-sao-les-mills-body-attack-la-bo-mon-giup-cai-thien-suc-ben-tim-mach-01.jpg',
      title: 'Tại sao Les Mills body attack là bộ môn giúp cải thiện sức bền tim mạch.',
      routerLink: '/news/news5'
    },
    {
      image: 'assets/News/tap-les-mills-body-combat-co-the-dot-bao-nhieu-calo-moi-buoi-su-that-bat-ngo-01.jpg',
      title: 'Tập Les Mills body combat có thể đốt bao nhiêu calo mỗi buổi, sự thật bất ngờ.',
      routerLink: '/news/news6'
    },
    {
      image: 'assets/News/tap-les-mills-body-pump-co-giup-tang-co-khong-cach-toi-uu-hoa-ket-qua-01.jpg',
      title: 'Tập Les Mills body pump có giúp tăng cơ không? Cách tối ưu hoá kết quả.',
      routerLink: '/news/news7'
    },
    {
      image: 'assets/News/tap-les-mills-body-pump-co-loi-ich-gi-nhung-ly-do-ban-nen-bat-dau-ngay-hom-nay-01.jpg',
      title: 'Tập Les Mills body pump có lợi ích gì? Những lý do bạn nên bắt đầu ngay hôm nay.',
      routerLink: '/news/news8'
    },
    {
      image: 'assets/News/tap-les-mills-body-pump-o-dau-de-dat-hieu-qua-toi-uu-01.jpg',
      title: 'Tập Les Mills body pump ở đâu để đạt hiệu quả tối ưu?',
      routerLink: '/news/news9'
    },
    {
      image: 'assets/News/AVA WEB_Mahadetox.jpg',
      title: 'Demo',
